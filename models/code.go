...
type Code struct {
	...
	Version   string    `orm:"column(version);size(10)" description:"版本号"`
	ServiceId int       `orm:"column(service_id)" description:"服务id"`
	Code      int       `orm:"column(code)" description:"返回码"`
	Content   string    `orm:"column(content);size(400)" description:"描述"`
	Status    int8      `orm:"column(status)" description:"0有效1删除"`
